<?php
/**
 * Script de Teste Corrigido - ETAPA 1.4: Diário de Classe
...
try {
    ...
    $diarioComAuditoria = $db->fetch("
        ...
        WHERE id = ? AND criado_por IS NOT NULL
    ", [$diarioId]);
    
    if ($diarioComAuditoria) {
        echo "   ✅ PASSOU - Auditoria funcionando (criado_por: " . $diarioComAuditoria['criado_por'] . ")\n";
    } else {
