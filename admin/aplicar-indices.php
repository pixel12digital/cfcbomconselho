<?php
/**
 * Script Simplificado para Aplicar Índices FASE 4
 * Sistema CFC - Bom Conselho
 * 
 * Versão alternativa com caminhos mais simples
 */
                    ...
                    <div class="card-body">
                        ...
                        <?php else: ?>
                            <div class="log-box" id="logBox">
                                ...
                                <div class="log-info">📋 Prioridade: <?php echo strtoupper($prioridade); ?></div>
                                ...
                                try {
                                    ...
                                    echo '<div class="log-info">⏱️ Tempo: ' . $tempo . ' segundos</div>';
                            ...
                            <div class="mt-4">
                                <a href="aplicar-indices.php" class="btn btn-primary">🔄 Executar Outro Script</a>
