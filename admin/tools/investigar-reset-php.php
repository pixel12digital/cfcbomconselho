<?php
/**
 * Script PHP para investigar token de reset
 * Execute localmente ou via linha de comando
 */
...
echo "=== INVESTIGAÇÃO TOKEN DE RESET ===\n\n";

$db = db();

// 1. Informações do token
echo "1. INFORMAÇÕES DO TOKEN\n";
...
if ($reset) {
    ...
    echo "   Motivo (se inválido): " . ($validation['reason'] ?? 'N/A') . "\n\n";
    ...
    echo "   Hash procurado: " . substr($tokenHash, 0, 32) . "...\n\n";
    
    // Verificar se há tokens similares (para debug)
    echo "   Verificando últimos tokens gerados...\n";
